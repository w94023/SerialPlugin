...
{
    internal class ComHandle : EventManager
	{
        ...
        internal int            receiveByteSize      = 1;
        ...
        internal virtual void SetPPSLimit(int PPSLimit) { }
        internal virtual void SetCPULimit(double CPULimit) { }
        internal virtual void SetMemoryLimit(int memoryLimit) { }
        internal virtual float[] CheckResources() { return new float[]{ -1, -1 }; }
        internal virtual void Test(double cpuUsage, int memoryRemained) { }
    ...
    internal class PacketManager
    {
		...
		{
            if (stopByte.Length == 0 || stopByte == null) {
