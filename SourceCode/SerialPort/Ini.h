...
public:
	...
	void   LoadString(const char* keyName, char* returnedString, DWORD nSize, const char* defaultValue = "");
	...
	void Transfer(bool bSave, const char* keyName, char* value, DWORD nSize, const char* defaultValue = "");
