...
CDAQCom::CDAQCom(LogManager& log, EventManager eventManager, std::wstring deviceName, std::vector<std::string> ports, int portsNum) :
	PortManager(log, eventManager)
{
...
void CDAQCom::GetRecvData(char* data)
{
